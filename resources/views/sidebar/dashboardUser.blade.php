<nav class="navbar navbar-expand sticky-top flex-row align-items-start py-2 col-md-2 min-vh-100 position-fixed side_bar" style="background-color: black; top:10%;">
